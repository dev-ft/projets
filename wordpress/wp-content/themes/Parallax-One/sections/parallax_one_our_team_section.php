		...
		<?php parallax_hook_team_top(); ?>
				...
				if ( ! empty( $parallax_one_our_team_title ) || ! empty( $parallax_one_our_team_subtitle ) ) {  ?>
						...
						if ( ! empty( $parallax_one_our_team_title ) ) {  ?>
							<?php echo esc_attr( $parallax_one_our_team_title ); ?>
						<?php
				...
				if ( ! empty( $parallax_one_team_content ) ) {  ?>
					<div class="row team-member-wrap">
					    <div id="container_titre">
                            <p id="titre_vid">La pâte de nos pizzas est faite maison</p>
                        </div>
						<video controls id="fait-maison">
  							<source src="wp-content/themes/Parallax-One_enfant/vidéos/production.mp4" type="video/mp4">
  							<source src="wp-content/themes/Parallax-One_enfant/vidéos/production_npec.ogv" type="video/ogg">
  							Votre navigateur ne prend pas en charge le format de cette vidéo.
						</video>
